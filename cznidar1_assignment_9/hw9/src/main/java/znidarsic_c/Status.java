...
public class Status {
	...
	public ArrayList<String[]> getStatus(String[] input) {
        ...
        String query = "SELECT COURSE_ID, COURSE_TITLE, NUMBER_REGISTERED FROM COURSES WHERE COURSE_ID IN (";
	...
	public ArrayList<String[]> getAllStatus(String[] input) {
        ...
        Query nativeQuery = entityManager.createNativeQuery("SELECT COURSE_ID, COURSE_TITLE, NUMBER_REGISTERED FROM COURSES");
        List<Object[]> resultList = nativeQuery.getResultList();
