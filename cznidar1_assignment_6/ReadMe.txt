...
Content:
	...
	This version adds functionality to generate reports about student enrollment numbers in selected courses. This function is implemented using a stateless Enterprise Java Bean (Status.java) that is called within the RegistrationController servlet. The registration report page is generated dynamically by a JSP called Status.jsp.
	This version also implements a join on the H2 database when querying Course_Id, Course_Title and Number_Registered.
